...
public final class SharedItemBridge implements ItemBridge {
    ...
    public Object copyWithCount(Object nmsItem, int count) {
        net.minecraft.world.item.ItemStack stack = ((net.minecraft.world.item.ItemStack) nmsItem).copy();
    ...
    public boolean isEmpty(Object nmsItem) {
        return nmsItem == null || ((net.minecraft.world.item.ItemStack) nmsItem).isEmpty();
    }
